...
//	private Font typeFont = Font.loadFont("file:./asset/font/FANTIQUE.TTF", 40);
	private Font comboFont = Font.loadFont(getClass().getClassLoader().getResourceAsStream("asset/font/JUNGJ___.TTF"), 120);
	private Font typeFont = Font.loadFont(getClass().getClassLoader().getResourceAsStream("asset/font/FANTIQUE.TTF"), 40);
